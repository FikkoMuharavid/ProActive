      ...
      <div className="right-section">
        <div className="content">
          ...
          >
            ...
            <Link to="/ForgotPassword" className="forgot-password"  style={{ color: "blue", cursor: "pointer" }}>
              Lupa Password?
            </Link>
          ...
          <p className="register-link" >
            <div style={{ display: "inline", textShadow: "2px 2px 2px rgba(0, 0, 0, 0.3)", margin: "5px" }}>Belum punya akun?</div><Link to="/Daftar"  style={{ color: "blue", cursor: "pointer", display: "inline", textShadow: "2px 2px 2px rgba(0, 0, 0, 0.1), ", marginLeft: "5px" }}>Daftar disini</Link>
          </p>
        </div>
      </div>
    </div>
